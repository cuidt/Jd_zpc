...
import com.jd_zpc.weight.AddDelView;
...
public class MyErAdapter extends BaseExpandableListAdapter{
    private Context context;
    private List<CarBean.DataBean> glist;
    private List<List<CarBean.DataBean.ListBean>> clist;
    private int count;
    ...
    public MyErAdapter(Context context, List<CarBean.DataBean> glist, List<List<CarBean.DataBean.ListBean>> clist) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        CarBean.DataBean dataBean = glist.get(groupPosition);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = View.inflate(context, R.layout.chlid_item, null);
            holder.cb = view.findViewById(R.id.cb);
        ...
        final CarBean.DataBean.ListBean listBean = clist.get(groupPosition).get(childPosition);
        ...
        holder.bt_del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onItemClistener!=null){
                    onItemClistener.onitemclick(pid);
                }
            }
        });
    ...
    class GroupCbOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v instanceof CheckBox) {
                ...
                List<CarBean.DataBean.ListBean> listBeans = clist.get(groupposition);
    ...
    class ChildCbOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v instanceof CheckBox){
                CheckBox cb = (CheckBox) v;
                List<CarBean.DataBean.ListBean> listBeans = clist.get(groupPosition);
                CarBean.DataBean.ListBean listBean = listBeans.get(childPosition);
                listBean.setChecked(cb.isChecked());
    ...
    private boolean isGroupChecked() {
        for (CarBean.DataBean group : glist) {
            if (!group.isChecked()) {
                return false;
            }
        }
    ...
    //判断商家的所有商品是否选中
    private boolean ischildChecked(List<CarBean.DataBean.ListBean> childlist) {
        for (int i = 0; i < childlist.size(); i++) {
            CarBean.DataBean.ListBean listBean = childlist.get(i);
