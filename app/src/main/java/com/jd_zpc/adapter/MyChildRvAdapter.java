...
public class MyChildRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ParentBean.DataBean.ListBean> list;
    ...
    public MyChildRvAdapter(Context context, List<ParentBean.DataBean.ListBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ParentBean.DataBean.ListBean listBean = list.get(position);
